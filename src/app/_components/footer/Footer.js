      ...
      <div className='container-xxl'>
        <div className='row'>
          <div className='col-12 d-flex flex-column'>
            <div className='d-flex mx-auto w-100 justify-content-around py-2'>
              <a href='tel: 6477675432' className='footer-link me-4'>
                <div className='d-flex my-2'>
                  <FiPhone className='my-auto' size={30} />
                  <h4 className='my-auto d-none d-xl-block'>
                    &nbsp;(647) 767-5432
                  </h4>
                </div>
              </a>
